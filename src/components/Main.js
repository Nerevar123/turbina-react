  ...
  <main className="content">
    <section className="description">
      <article className="description__article">
        <h2 className="description__heading">О проекте.</h2>
